...
def read_NX2(self, filename, date, corr_bsp = 1.,origin = None, timeoffset = 2):
    ...
    '''
    try:
        atpy.Table.__init__(self, filename, type='ascii', delimiter=',', fill_values=('','nan'), guess=False, data_start = 3)
        ...
        atpy.Table.__init__(self, filename, type='ascii', delimiter=',', names=names, fill_values=('','nan'), guess=False, data_start = 3)
