...
plotpath = '/home/moritz/Dropbox/NX2/2010/'
...
plt.savefig(plotpath + 'report/kal_speeds.png')
...
ind = con
plt.clf()
plt.plot(d19.SOG[ind], d19.BSP[ind], 'r.', label = '2. Tag')
plt.plot(d18.SOG[ind], d18.BSP[ind], 'b.', label = '1. Tag')
plt.plot(kal.SOG[ind], kal.BSP[ind], 'b.', label = '1. Tag')
